...
@interface JHCollectionHeaderController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout>
/** collectionView  */
...
@end
@implementation JHCollectionHeaderController
...
{
    //如果是头部视图 (因为这个代理方法有头部和尾部,默认为头部,判断的话比较严谨)
